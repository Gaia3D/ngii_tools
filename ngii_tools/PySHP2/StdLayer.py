...
class StdLayer:
    ...
    def getStdChk(self, layerId):
        layerId = layerId.upper()
        layer_list = [
            "TN_CTPRVN_BNDRY", "TN_SIGNGU_BNDRY", "TN_EMD_BNDRY", "TN_FCLTY_ZONE_BNDRY",
            "TN_RODWAY_CTLN", "TN_RODWAY_BNDRY", "TN_FTPTH_CTLN", "TN_FTPTH_BNDRY", "TN_BCYCL_CTLN", "TN_ARRFC", "TN_LNRFC", "TN_PTRFC",
            "TN_RLROAD_CTLN", "TN_RLROAD_BNDRY", "TN_ARWFC", "TN_PTWFC", "TN_ARAFC", "TN_LNAFC", "TN_PTAFC", "TN_ARHFC", "TN_PTHFC",
            "TN_BULD", "TN_BULD_ADCLS", "TN_ARSFC", "TN_LNSFC", "TN_PTSFC", "TN_CTRLN", "TN_SHORLINE", "TN_ALPT", "TN_PTPGR",
            "TN_LNPGR", "TN_ARPGR", "TN_RIVER_BNDRY", "TN_RIVER_BT", "TN_RIVER_CTLN", "TN_LKMH", "TN_WTCORS_FCLTY", "TN_FMLND_BNDRY", "TN_MTC_BNDRY"
        ]
        end_chk = ["N", "R", "PE", "GE", "PGE"]
        layer_split = layerId.split("_")
        if layer_split[-1] in end_chk:
            layer = list()
            for i in range(len(layer_split)-1):
                layer.append(layer_split[i])
            layer = "_".join(layer)
        else:
            layer = layerId
